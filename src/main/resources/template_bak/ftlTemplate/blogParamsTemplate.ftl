...
<#if blog??>
    ...
    <span style="margin-right: 10px">
        <img class="myIcon" src="/static/icons/calendar.svg" title="创建日期">
        ${blog.createTime?string("yyyy-MM-dd")}
    </span>
    <span style="margin-right: 10px">
        <img class="myIcon" src="/static/icons/arrow-repeat.svg" title="更新日期">
        ${blog.updateTime?string("yyyy-MM-dd")}
    </span>
    <span style="margin-right: 10px">
        <img class="myIcon" src="/static/icons/eye.svg" title="观看人数">
        ${blog.hot!}
    </span>
