...
<#macro info>
    ...
    <div class=" center">
        <#--图片-->
        <div>
            <img src="/img/myself.jpg" class="rounded-circle" style="margin: 10px">
    ...
    <div class="whiteBlock" >
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a class="text-body" style="font-family: Menlo">2020年</a>
                <span class="badge badge-blue badge-pill">1111</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a class="text-body" style="font-family: Menlo">2021年</a>
                <span class="badge badge-blue badge-pill">11</span>
            </li>
        </ul>
    </div>
</#macro>