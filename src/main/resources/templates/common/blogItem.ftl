    ...
    <#if blog??>
        <div>
            ...
            <h4 class="overHide" style="padding: 0 60px 0 0">
                ...
                <a href="javascript:void(0);" onclick="openAddTagToBlogModal(${blog.id!})" style="font-size: 60%">添加标签</a>
            </h4>
            <#--标签-->
            ...
            <#--概述-->
            <div class="text-muted" style="padding: 7px 0 2px 2px;word-break:break-all">${blog.desc!}</div>
        </div>
